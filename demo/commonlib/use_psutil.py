...
#获取磁盘信息  通过psutil获取磁盘分区、磁盘使用率和磁盘IO信息
...
#得到一个AccessDenied错误，原因是psutil获取信息也是要走系统接口，而获取网络连接信息需要root权限

#通过psutil可以获取到所有进程的详细信息
print(psutil.pids()) # 所有进程ID
p = psutil.Process(3776)
print(p) # 获取指定进程ID=3776，其实就是当前Python交互环境
print(p.name()) # 进程名称
print(p.exe()) # 进程exe路径
print(p.cwd()) # 进程工作目录
